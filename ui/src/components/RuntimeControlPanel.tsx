...
export function RuntimeControlPanel() {
  ...
  const acceptRuntimeAction = useRuntimeActionFeedback(value, setNotice)
  ...
  const pendingMessage = runtimeState === 'starting' ? t('pendingHealthCheck') : t('pendingChange')
  ...
  return <>
    <Card className="min-w-0 overflow-hidden">
      ...
      {uiMode === 'advanced' && value?.network_automation?.enabled ? <div className="mx-4 mb-4 rounded-md border border-[var(--border)] bg-[var(--surface-subtle)] p-3 text-sm md:mx-5 md:mb-5">
