...
const zh = {
  overview: '总览', customNodes: '自定义节点', subscriptions: '订阅转换', proxies: '代理', connections: '连接', rules: '规则', traffic: '流量', logs: '日志', networkTest: '网络测试', management: '管理',
  ...
  managedRuntime: '受管核心运行状态', sempreService: 'Sempre Service', managedCore: '受管核心', online: '在线', desiredState: '期望状态', actualState: '实际状态', selectedReference: '选择引用', configuration: '活动配置', runtimeUptime: '运行时长', restarts: '自动重启', lastTransition: '最近变化', lastExit: '最近退出', lastError: '最近错误', coreNotRunning: '受管核心未运行', coreNotRunningDetail: '核心运行后将显示流量和连接数据。',
	startCore: '启动受管核心', stopCore: '停止受管核心', restartCore: '重启受管核心', operationAccepted: '操作已受理', pendingChange: '存在待应用的核心或配置变更，将在核心健康运行后提交。', viewLogs: '查看日志', coreStopTitle: '停止受管核心？', coreStopWarning: '停止 {core} 会立即中断当前代理流量。Sempre Service、Web 控制台和 API 将继续运行。', cancel: '取消', confirm: '确认',
...
const en: Record<Key, string> = {
  overview: 'Overview', customNodes: 'Custom Nodes', subscriptions: 'Subscriptions', proxies: 'Proxies', connections: 'Connections', rules: 'Rules', traffic: 'Traffic', logs: 'Logs', networkTest: 'Network Test', management: 'Management',
