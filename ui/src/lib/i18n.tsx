...
const zh = {
  overview: '总览', customNodes: '自定义节点', subscriptions: '订阅转换', proxies: '代理', connections: '连接', rules: '规则', traffic: '流量', logs: '日志', management: '管理',
  ...
  startCore: '启动受管核心', stopCore: '停止受管核心', restartCore: '重启受管核心', operationAccepted: '操作已受理', pendingChange: '存在待应用的核心或配置变更，将在核心健康运行后提交。', viewLogs: '查看日志', coreStopTitle: '停止受管核心？', coreStopWarning: '停止 sing-box 会立即中断当前代理流量。Sempre Service、Web 控制台和 API 将继续运行。', cancel: '取消', confirm: '确认',
...
const en: Record<Key, string> = {
  overview: 'Overview', customNodes: 'Custom Nodes', subscriptions: 'Subscriptions', proxies: 'Proxies', connections: 'Connections', rules: 'Rules', traffic: 'Traffic', logs: 'Logs', management: 'Management',
