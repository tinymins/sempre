...
const zh = {
  ...
  install: '安装', remove: '移除', use: '使用', reference: '核心引用', installedVersions: '已安装版本',
...
const en: Record<Key, string> = {
  ...
  install: 'Install', remove: 'Remove', use: 'Use', reference: 'Core reference', installedVersions: 'Installed versions',
