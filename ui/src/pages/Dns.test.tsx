  ...
  beforeEach(() => {
    ...
    vi.stubGlobal('fetch', vi.fn(async (input: RequestInfo | URL) => {
      ...
      if (path.endsWith('/dns/queries')) return Response.json({ queries: [
        { time: 1_725_000_000_000, client: '10.23.0.153', name: 'example.com.', type: 'A', decision: 'core', answers: ['example.com. 60 IN CNAME edge.example.com.', 'edge.example.com. 60 IN A 198.18.0.1', 'edge.example.com. 60 IN A 198.18.0.2', 'alias.example.com. 60 IN A 198.18.0.1'], upstream: '127.0.0.1:20553', latency_ms: 2, detail: 'default-remote' },
        { time: 1_725_000_000_001, client: '10.23.0.154', name: 'example.cn.', type: 'A', decision: 'local', answers: [], upstream: 'tls://223.6.6.6:853?server_name=dns.alidns.com', latency_ms: 3, detail: 'rule-set:domestic-domains' },
      ] })
